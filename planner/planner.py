...
def test():
    ...
    solution = boand_star(domain_file, problem_file, problem_file[:problem_file.rfind("/")], use_metric="bw", use_cp_heuristic="hadd", use_best_case_heuristic="MinSum", use_worst_case_heuristic="MaxSum", use_size_heuristic="Zero", use_selector="random")
